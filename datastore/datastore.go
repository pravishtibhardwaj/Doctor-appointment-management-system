...
func (a appoint) GetByID(ctx *gofr.Context, id string) (model.Appointment, error) {
...
func (a appoint) GetAllAppointments(ctx *gofr.Context) ([]model.Appointment, error) {
...
func (a appoint) Create(ctx *gofr.Context, appoint model.Appointment) (model.Appointment, error) {
...
func (a appoint) Update(ctx *gofr.Context, appoint model.Appointment) (model.Appointment, error) {
...
func (a appoint) Delete(ctx *gofr.Context, id int) error {
